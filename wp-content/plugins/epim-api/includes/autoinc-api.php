...
function get_api_branch_stock($id) {
...
function create_branch($id, $name, $telephone, $email, $address)
{
    $response = '';
...
function update_branch_stock($id, $variation_id, $stock_level)
{
...
function getProductFromVariationID($variationID)
{
    $res = false;
