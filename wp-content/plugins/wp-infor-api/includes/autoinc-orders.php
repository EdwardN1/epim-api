...
function wpiai_get_changed_order_XML( $order_id, $action ) {
	...
	if ( $order ) {
		...
		$actionCode       = 'Change';
		$xmld             = get_option( 'wpiai_sales_order_change_xml' );
		...
		if ( $xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->DocumentID[0]->ID[0] ) {
			$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->DocumentID[0]->ID[0] = $CSD_ID;
		}

		if ( $xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->AlternateDocumentID[0]->ID[0] ) {
			$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->AlternateDocumentID[0]->ID[0]->attributes()['schemeAgencyID'] = $AlternateDocumentID_ID_schemeAgencyID;
			$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->AlternateDocumentID[0]->ID[0]                                 = $AlternateDocumentID_ID;
		}

		if ( $xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->Reference[0]->NameValue[0] ) {
			$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->Reference[0]->NameValue[0] = $Reference_NameValue_0;
		}

		if ( $xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->Reference[0]->NameValue[1] ) {
			$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->Reference[0]->NameValue[1] = $Reference_NameValue_1;
		}

		if ( $xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->DocumentDateTime[0] ) {
			$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->DocumentDateTime[0] = $Document_DateTime;
		}

		if ( $xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->Status[0]->Code[0] ) {
			$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->Status[0]->Code[0] = 'Open';
		}

		if ( $xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->CustomerParty[0]->PartyIDs[0]->ID[0] ) {
			$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->CustomerParty[0]->PartyIDs[0]->ID[0] = $CustomerParty_PartyIDs_ID;
		}

		if ( $xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->CustomerParty[0]->Name[0] ) {
			$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->CustomerParty[0]->Name[0] = $CustomerParty_Name;
		}

		if ( $xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->CustomerParty[0]->Communication[0]->URI[0] ) {
			$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->CustomerParty[0]->Communication[0]->URI[0] = $CustomerParty_Communication_URI;
		}

		if ( $xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->ShipFromParty[0]->Location[0]->ID[0] ) {
			$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->ShipFromParty[0]->Location[0]->ID[0] = $warehouse;
		}
		if ( $xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->ShipToParty[0]->PartyIDs[0]->ID[0] ) {
			$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->ShipToParty[0]->PartyIDs[0]->ID[0] = $shipToCSDID;
		...
		if ( $xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->TransportationMethodCode [0] ) {
			$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->TransportationMethodCode [0] = $TransportationMethodCode;
		}

		if ( $xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->UserArea[0]->Property[0]->NameValue[0] ) {
			$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->UserArea[0]->Property[0]->NameValue[0] = $order_id;
		}

		if ( $contact_ordered ) {
			if ( $xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->UserArea[0]->Property[1]->NameValue[0] ) {
				$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->UserArea[0]->Property[1]->NameValue[0] = $contactCSDID;
			}
		}
		...
		if ( $xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->UserArea[0]->Property[2]->NameValue[0] ) {
			$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->UserArea[0]->Property[2]->NameValue[0] = $CustomerPartyID;
		}

		if ( $xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->UserArea[0]->Property[3]->NameValue[0] ) {
			$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->UserArea[0]->Property[3]->NameValue[0] = $shipping_total - $shipping_tax;
		}

		if ( $xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->UserArea[0]->Property[4]->NameValue[0] ) {
			if ( $payment_method == 'stripe' ) {
				$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->UserArea[0]->Property[4]->NameValue[0] = 'Paid';
			}
			if ( $payment_method == 'cod' ) {
				$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderHeader[0]->UserArea[0]->Property[4]->NameValue[0] = 'Account';
			}
		...
		if ( $order->get_items() ) {
			...
			foreach ( $order->get_items() as $item_id => $item ) {
				...
				if ( $product ) {
					$sku = $product->get_sku();
					$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderLine[ $SalesOrderLineNum ]->Item[0]->ItemID[0]->ID[0]              = $sku;
				}
				$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderLine[ $SalesOrderLineNum ]->Quantity[0]                            = $quantity;
				$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderLine[ $SalesOrderLineNum ]->LineNumber[0]                          = $line_number;
				$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderLine[ $SalesOrderLineNum ]->UserArea[0]->Property[0]->NameValue[0] = $itemID;
				$xml->xpath( '//x:DataArea' )[0]->WooSalesOrder[0]->WooSalesOrderLine[ $SalesOrderLineNum ]->UserArea[0]->Property[0]->NameValue[0]->addAttribute( 'name', 'SXe_user2' );
				$SalesOrderLineNum ++;
...
function wpiai_get_order_XML( $order_id, $action ) {
	...
	if ( $order ) {
		...
		if ( $xml->xpath( '//x:DataArea' )[0]->SalesOrder[0]->SalesOrderHeader[0]->UserArea[0]->Property[3]->NameValue[0] ) {
			$xml->xpath( '//x:DataArea' )[0]->SalesOrder[0]->SalesOrderHeader[0]->UserArea[0]->Property[3]->NameValue[0] = $shipping_total;
		}
