...
$available_downloads = array(
  ...
  'photometric_ldt'             => 'Kosnic Photometric File - LDT',
...
if(empty($product_node->body) || $product_node->status !== 200):
  ...
  <h2 class="api-error"><?= $error_message; ?></h2>
...
<?php
  ...
  <section class="product-single js-product-single"
           data-product-node-id="<?= $node_id; ?>">
    <div class="container">
      <h1 class="product-single__title"><?= $product->name->common; ?></h1>
          ...
          <div class="product-single__images-inner grid">
            <div class="col-12 product-single__images-full">
              <div class="product-single__images-main js-lightbox"
                   style="<?= $product->background_image_url('medium', true); ?>"
                   data-mfp-src="<?= $product->image_url('large', true); ?>">
              </div>
            </div>
            <div class="product-single__images-grid">
              ...
              <?php if($product->image_url('tech1')): ?>
                ...
                <div class="col-4 product-single__images-thumbnail js-lightbox"
                     data-mfp-src="<?= $product->image_url('tech1'); ?>">
                  <img src="<?= $product->image_url('tech1'); ?>"
                       alt="<?= $product->attributes->images->tech1->alt; ?>" />
                </div>
              ...
              ?>
                ...
                <div class="col-4 product-single__images-thumbnail js-lightbox"
                     data-mfp-src="<?= $product->image_url('tech2'); ?>">
                  <img src="<?= $product->image_url('tech2'); ?>"
                       alt="<?= $product->attributes->images->tech2->alt; ?>" />
                </div>
              ...
              ?>
                ...
                <div class="col-4 product-single__images-thumbnail js-lightbox"
                     data-mfp-src="<?= $product->image_url('tech3'); ?>">
                  <img src="<?= $product->image_url('tech3'); ?>"
                       alt="<?= $product->attributes->images->tech3->alt; ?>" />
                </div>
        ...
        <div class="col-8 product-single__tabs">
          <ul class="tabs">
            ...
            <li class="tabs-content__accordion wysiwyg js-tabs-content active" id="tab-description-accordion">
              ...
              <ul>
                <?php foreach($product->datasheets->features as $key => $value): ?>
                  <li class="tabs-content__list"><?= $value; ?></li>
                <?php endforeach; ?>
              </ul>
            ...
            <li class="tabs-content__accordion tabs__download wysiwyg js-tabs-content" id="tab-downloads-accordion">
              ...
              <?php
               $has_pdf = false;
                foreach($available_downloads as $key => $value):
                ...
                ?>
                  ...
                  <li class="tabs-content__list">
                    <a class="disable-pdf-icon"
                       href="<?= $product_datasheet_pdf->body; ?>"
                       target="_blank">
    ...
    <div class="container product-single__related">
      <section class="related container">
        <div class="related__bar">
          ...
          <a href="<?= $breadcrumb_url; ?>">View All</a>
        </div>

        <section class="grid owl-carousel__related js-related-products"
                 data-parent-node="<?= $breadcrumb_category->ID; ?>">
        </section>
      </section>
